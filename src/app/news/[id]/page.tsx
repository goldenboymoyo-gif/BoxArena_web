...
const articleBodies: Record<string, ArticleSection[]> = {
  ...
  "ticket-scalping-crackdown": [
    ...
    },
    {
      heading: "Why Now",
      paragraphs: [
        "The WBC has pushed for stricter resale controls after fans paid multiples of face value for recent title fights, often from bots that bought out inventory in minutes. Pugnera and the WBC are betting the extra step at the door is worth it if it keeps prices closer to what's actually printed on the ticket.",
      ],
    },
  ],

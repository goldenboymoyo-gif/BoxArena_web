    ...
    <section className={`ccp ${className}`}>
      <div className="wrap">
        ...
        <section id="card" className={`card ${flip ? "flip" : ""}`}>
          ...
          {/* FRONT */}
          <section className="card__front" style={{ "--ring1": ring1, "--ring2": ring2 } as React.CSSProperties}>
          ...
          {/* BACK */}
          <section className="card__back" style={{ "--ring1": ring1, "--ring2": ring2 } as React.CSSProperties}>
